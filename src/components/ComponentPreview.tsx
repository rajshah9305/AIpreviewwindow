  ...
  return (
    <>
      ...
      {showCode ? (
        ...
        <div className="p-8 bg-gradient-to-br from-neutral-50/50 via-white to-primary-50/30 flex-1 overflow-auto scrollbar-hide">
          <div className={`w-full h-full min-h-[600px] transition-all duration-500 ${isExpanded ? 'min-h-[70vh]' : ''}`}>
            <iframe
              ref={iframeRef}
              srcDoc={`
                <!DOCTYPE html>
              ...
              `}
              className="w-full h-full border-0 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ring-1 ring-neutral-200/50"
