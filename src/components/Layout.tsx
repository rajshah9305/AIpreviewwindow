...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-white text-black selection:bg-orange-500/10 selection:text-orange-600">
      ...
      <nav className="sticky top-0 z-[100] w-full px-2 sm:px-4 md:px-6 py-2.5 sm:py-3 md:py-4">
        <div className="max-w-5xl mx-auto glass rounded-xl md:rounded-2xl px-2 sm:px-4 md:px-6 py-2 md:py-2.5 shadow-premium flex items-center justify-between">
      ...
      <main className="max-w-6xl mx-auto px-2 sm:px-4 md:px-6 py-6 sm:py-8 md:py-12 relative z-10">
        {children}
      </main>

      <footer className="max-w-6xl mx-auto px-2 sm:px-4 md:px-6 py-6 sm:py-8 md:py-12 border-t border-neutral-50 relative z-10">
      </footer>
    </div>
  )
}
