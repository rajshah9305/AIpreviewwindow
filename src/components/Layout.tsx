  ...
  return (
    <div className="min-h-screen bg-[#faf8f6] text-black selection:bg-orange-500/10 selection:text-orange-600">
      ...
      <nav className="sticky top-0 z-[100] w-full px-3 sm:px-4 md:px-6 py-2.5 sm:py-3 md:py-3.5">
        <div className="max-w-5xl mx-auto bg-white border border-neutral-200 rounded-xl md:rounded-2xl px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 shadow-[0_8px_32px_rgba(0,0,0,0.06)] flex items-center justify-between">
