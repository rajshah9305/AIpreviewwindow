  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[200] w-full bg-gradient-to-t from-[#faf8f6] via-[#faf8f6] to-transparent pt-4">
      <div className="w-full max-w-3xl mx-auto px-2 sm:px-3 md:px-4 lg:px-6 pb-2 sm:pb-3 md:pb-4 lg:pb-6">
        <div className="bg-white/98 backdrop-blur-xl border-[3px] border-neutral-900 rounded-xl sm:rounded-2xl md:rounded-3xl p-2 sm:p-2.5 md:p-3 shadow-[0_12px_48px_rgba(0,0,0,0.15)] group/input transition-all duration-300 focus-within:border-orange-500 focus-within:shadow-[0_16px_64px_rgba(249,115,22,0.2)] w-full">
          {error && (
          ...
          <div className="flex items-end gap-2 sm:gap-2.5 md:gap-3">
            <div className="flex-1 min-w-0">
              <textarea
                ...
                className="w-full bg-transparent border-none focus:outline-none focus:ring-0 px-3 sm:px-4 py-3 sm:py-3.5 md:py-4 text-base font-sans font-medium placeholder:text-neutral-400 resize-none min-h-[52px] max-h-[120px] scrollbar-hide text-neutral-900 leading-relaxed rounded-lg"
