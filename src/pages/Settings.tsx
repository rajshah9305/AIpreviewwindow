...
const SettingsForm = ({
  ...
  <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl border-2 border-neutral-200 p-4 sm:p-5 md:p-6 lg:p-7 xl:p-8 space-y-4 sm:space-y-5 md:space-y-6 shadow-[0_8px_32px_rgba(0,0,0,0.08)] relative overflow-hidden w-full">
    ...
    <button
      onClick={onSave}
      disabled={!isModified}
      className={`w-full py-2.5 sm:py-3 md:py-3.5 rounded-lg sm:rounded-xl font-display font-bold uppercase tracking-[0.1em] transition-all duration-300 flex items-center justify-center gap-1.5 sm:gap-2 md:gap-2.5 active:scale-[0.98] text-[10px] sm:text-xs md:text-sm touch-manipulation ${
        isModified
